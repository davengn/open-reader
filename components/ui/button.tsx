...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-coral text-white hover:bg-coral-dark shadow-[0_6px_20px_rgba(204,120,92,0.18)]",
        destructive:
          "bg-danger text-white hover:bg-danger/90",
        outline:
          "border border-line bg-surface text-ink hover:bg-canvas-strong hover:text-ink",
        secondary:
          "bg-surface/82 border border-line text-ink hover:bg-white hover:border-line-strong",
        ghost: "hover:bg-canvas-strong hover:text-ink text-ink",
